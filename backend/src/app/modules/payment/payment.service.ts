...
export const initiatePaymentService = async (
  ...
  const data = {
    ...
    currency: 'BDT',
    tran_id: tranId,
    success_url: `${config.base_url}/api/payments/callback/success`,
    fail_url: `${config.base_url}/api/payments/callback/fail`,
    cancel_url: `${config.base_url}/api/payments/callback/cancel`,
    ipn_url: `${config.base_url}/api/payments/webhook`,
    shipping_method: 'No',
